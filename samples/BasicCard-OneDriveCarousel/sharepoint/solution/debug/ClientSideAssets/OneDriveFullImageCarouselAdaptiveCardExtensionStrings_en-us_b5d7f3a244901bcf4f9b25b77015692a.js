define([], function() {
  return {
    "PropertyPaneDescription": "Viva Connection Adaptive Card Extension (ACE) that shows a carousel of the images inside a OneDrive folder with no button or quick view.",
