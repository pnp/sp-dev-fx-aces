...
var QuickViewComponent = function (props) {
    ...
    return (React.createElement("div", { className: styles.container },
        ...
        React.createElement("p", null,
            "List Name: ",
            props.listName),
        loading ? (React.createElement("p", null, "Loading items...")) : error ? (React.createElement("p", null, error) // Display error message if an error occurred or list name is missing
        ) : (React.createElement("ul", null, listItems.length > 0 ? (listItems.map(function (item) { return (React.createElement("li", { key: item.Id },
