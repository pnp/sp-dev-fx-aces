...
export const star: string = require('./assets/star.svg');
export const starFilled: string = require('./assets/starfilled.svg');
...
export function mapLine(tflLine: TfLLine, favouriteLineId: string): Line {
    ...
    return {
        ...
        iconSvg: getIconSvg(tflLine.id),
        isFavourite,
        favouriteIconSvg: isFavourite ? starFilled : star,
        statusStyle: statusSeverity === 10 ? "default" : "attention",
        columnStyle: isFavourite ? "warning" : "default"
    };
}
